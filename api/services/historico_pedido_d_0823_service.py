from ..models import historico_pedido_d_0823_model, estoque_model
from sqlalchemy.orm import aliased
from api import db
from sqlalchemy import desc


def listar_historico_pedido_d_0823():
    hist = aliased(historico_pedido_d_0823_model.HistoricoPedidosD0823Model)
