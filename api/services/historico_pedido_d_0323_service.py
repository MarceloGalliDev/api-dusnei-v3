from ..models import historico_pedido_d_0323_model, estoque_model
from sqlalchemy.orm import aliased
from api import db
from sqlalchemy import desc


def listar_historico_pedido_d_0323():
    hist = aliased(historico_pedido_d_0323_model.HistoricoPedidosD0323Model)
