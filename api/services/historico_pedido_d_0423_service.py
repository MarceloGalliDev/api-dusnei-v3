from ..models import historico_pedido_d_0423_model, estoque_model
from sqlalchemy.orm import aliased
from api import db
from sqlalchemy import desc


def listar_historico_pedido_d_0423():
    hist = aliased(historico_pedido_d_0423_model.HistoricoPedidosD0423Model)
