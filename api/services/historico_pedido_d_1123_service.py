from ..models import historico_pedido_d_1123_model, estoque_model
from sqlalchemy.orm import aliased
from api import db
from sqlalchemy import desc


def listar_historico_pedido_d_1123():
    hist = aliased(historico_pedido_d_1123_model.HistoricoPedidosD1123Model)
