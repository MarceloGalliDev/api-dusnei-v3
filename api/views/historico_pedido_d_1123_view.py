...
import datetime
from ..services import historico_pedido_d_1123_service

class HistoricoPedidosD1123List(Resource):
    def get(self):
        page = request.args.get('page', 1, type=int)
        per_page = 150000
        
        historico_pedido_d_query = historico_pedido_d_1123_service.listar_historico_pedido_d_1123()
...
api.add_resource(HistoricoPedidosD1123List, '/historico-pedido-d-1123') 