...
import datetime
from ..services import historico_pedido_d_1223_service

class HistoricoPedidosD1223List(Resource):
    def get(self):
        page = request.args.get('page', 1, type=int)
        per_page = 100
        
        historico_pedido_d_query = historico_pedido_d_1223_service.listar_historico_pedido_d_1223()
...
api.add_resource(HistoricoPedidosD1223List, '/historico_pedido_d_1223') 