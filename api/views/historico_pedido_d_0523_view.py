...
import datetime
from ..services import historico_pedido_d_0523_service
import os
import logging
import time
import requests
...
class HistoricoPedidosD0523List(Resource):
    def get(self):
        page = request.args.get('page', 1, type=int)
        per_page = 200000
        
        historico_pedido_d_query = historico_pedido_d_0523_service.listar_historico_pedido_d_0523()
        ...
        logging.basicConfig(
            filename='api_post_log_historico_pedido_d_0523.txt', 
            level=logging.INFO, 
...
api.add_resource(HistoricoPedidosD0523List, '/historico-pedido-d-0523') 