...
import datetime
from ..services import historico_pedido_d_1023_service

class HistoricoPedidosD1023List(Resource):
    def get(self):
        page = request.args.get('page', 1, type=int)
        per_page = 150000
        
        historico_pedido_d_query = historico_pedido_d_1023_service.listar_historico_pedido_d_1023()
...
api.add_resource(HistoricoPedidosD1023List, '/historico-pedido-d-1023') 